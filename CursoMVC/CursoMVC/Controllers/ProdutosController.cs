...
namespace CursoMVC.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        {
            //ViewData["CategoriaId"] = new SelectList(_context.Categorias, "Id", "Id"); //go to database and creates a selectlist with all categorias
            ViewData["CategoriaId"] = new SelectList(_context.Categorias, "Id", "Descricao"); //change to in view presents descrição
            return View();
        }
